        ...
        <div className=''>
            <div className=" border-b border-lime-600 mb-3 ">
                <div className='mx-15 flex flex-row p-1'>
                    <a href="tel:+554839998877" className="flex items-center gap-1 hover:text-green-600 transition-colors duration-300" >
                        <Phone size={18}/> +55 (48) 3999-8877
                    </a>
                    <span className='mx-2'>|</span>
                    <a href="mailto:contato@rema.ufsc.br" className="flex items-center gap-1 hover:text-green-600 transition-colors duration-300" >
            ...
            <div className=' mx-15 flex flex-row items-center'>
                ...
                <Link href={'/calculadora'} className='hover:text-lime-700 text-gray-700 px-4 font-medium transition-colors duration-300 tracking-wider'>
