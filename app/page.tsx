      ...
      <div className="max-w-3xl bg-gray-100 rounded-2xl shadow-xl p-8 border border-lime-600 mx-auto">
        ...
        <div className="mb-6 p-5 bg-white rounded-lg border">
          ...
          <p className="text-gray-700 mb-4">
            ...
            quantidade de um contaminante absorvida por uma pessoa. A
            fórmula utilizada é:
          </p>
        ...
        <div className="mb-6 p-5 bg-white rounded-lg border">
          ...
          <p className="text-gray-700 mb-4">
            ...
            o Quociente de Risco (QR). Isso é feito
            comparando-se a ingestão com a Dose de Referência (RfD) do
            contaminante.
          </p>
          ...
          <p className="text-gray-700">
            ...
            exposição sem efeitos adversos. A calculadora obtém
            esse valor automaticamente da nossa base de dados quando você
            seleciona o contaminante.
          </p>
        </div>
