        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border text-black border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-lime-700 focus:border-lime-500 transition-colors"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-lime-600 hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
            >
              {isLoading ? (
                <div className="flex items-center">
                  ...
                  {isSignIn ? "Cadastrando..." : "Criando sua conta..."}
                </div>
              ) : isSignIn ? (
                "Entrar"
              ) : (
          ...
          <div className="text-center">
            <button
              ...
              className="text-lime-600 hover:text-lime-900 text-sm font-medium transition-colors"
            >
              {isSignIn
